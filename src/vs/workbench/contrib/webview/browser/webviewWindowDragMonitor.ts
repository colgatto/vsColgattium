...
/**
 * Allows webviews to monitor when an element in the VS Colgattium editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. VS Colgattium needs to see this
